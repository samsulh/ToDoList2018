...
<html lang="en">
    ...
    <body>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="pending.php">Pending Tasks <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
        ...
        echo "<h3>Number of Pending Tasks: $numRowsPending</h3>";
        ...
        while($row = mysqli_fetch_assoc($pendingTasksResult))
        {
            echo "<tr>";
